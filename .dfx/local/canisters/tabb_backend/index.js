...
import { idlFactory } from './tabb_backend.did.js';
export { idlFactory } from './tabb_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TABB_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./tabb_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the tabb_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./tabb_backend.did.js")._SERVICE>}
 */
export const tabb_backend = createActor(canisterId);
